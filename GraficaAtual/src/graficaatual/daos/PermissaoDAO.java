...
public class PermissaoDAO extends GenericDAO {
    ...
    public Permissao getPermissaoFormulario(int codUsuario,String formulario){

        return getPurePojoUnique(Permissao.class, "select e from Permissao e where e.usuario.codigo=?1 and e.formulario.formulario=?2",codUsuario,formulario);
    }
