 ...
 *
 */
public class ControleNavegacaoRNE extends GenericDAO {

    private static final long serialVersionUID = 8563567069542816419L;
    ...
    public void proximo(EntityManager session, Object... parametros) {
        try {
            ...
            if (posisaoInicial < qtdeRegTotal) {
                ...
                List<Serializable> merged = getPureList(session, posisaoInicial, qtdeRegCarregado, c, sqlBuscaLista,
                        parametros);
                entidadeList.clear();
                entidadeList.addAll(merged);
    ...
    public void atualizarPosisaoRegistro(EntityManager session, Object... parametros) {
        try {
            ...
            int i = getInteger(session, sqlQuantidadeRegistro, parametros);
    ...
    // -------------------------------------------------------------------------------------
    @SuppressWarnings("unchecked")
    public <T extends Serializable> List<T> getLista(EntityManager session, int posisaoInicial, int qtdeRegCarregado, Object... parametros) {
